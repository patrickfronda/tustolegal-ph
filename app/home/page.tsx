...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="bg-[#0e1f44] text-white sticky top-0 z-50 shadow-lg">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm font-medium">
            ...
            <a href="#why-torny" className="text-blue-200 hover:text-white transition-colors">Why Torny?</a>
      ...
      {/* Why Torny AI? */}
      <section id="why-torny" className="py-16 bg-white scroll-mt-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-3">
            <span className="inline-flex items-center gap-2 bg-[#fcd116]/15 text-[#1e3a7b] text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {WHY_TORNY.map((w) => (
              <div key={w.title} className="bg-gray-50 rounded-2xl p-6 border border-gray-100 hover:shadow-md transition-shadow">
                <div className="w-11 h-11 rounded-full bg-[#0e1f44] flex items-center justify-center mb-4">
                  <w.icon className="w-5 h-5 text-[#fcd116]" />
                </div>
                <h3 className="font-bold text-[#0e1f44] mb-1.5">{w.title}</h3>
          ...
          <div className="text-center mt-6">
            <Link href="/" className="inline-flex items-center gap-2 bg-[#fcd116] text-[#0e1f44] px-6 py-3.5 rounded-full font-bold hover:bg-yellow-300 transition shadow-lg">
              Try Torny AI Free* <ArrowRight className="w-5 h-5" />
            </Link>
          </div>
        </div>
      </section>
