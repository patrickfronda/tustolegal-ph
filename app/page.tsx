    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-800 via-blue-700 to-indigo-800 flex flex-col">
      ...
      <header className="px-6 pt-12 pb-4 text-center">
        <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur px-4 py-2 rounded-full mb-6">
          ...
          <span className="text-white text-sm font-medium">TustoJobs ME</span>
        </div>
        <h1 className="text-4xl font-bold text-white leading-tight">
          Your Dream Job<br />
          in the <span className="text-yellow-300">Middle East.</span>
        </h1>
        <p className="mt-4 text-blue-100 text-base max-w-xs mx-auto">
          Upload your CV and photo — we match you with top UAE & Middle East employers and send your applications automatically.
        </p>
      </header>
      ...
      <div className="px-6 mt-8 flex flex-col gap-3 max-w-md mx-auto w-full">
        {[
          ...
          { icon: Search, label: "We match you with UAE companies", color: "bg-green-400/20" },
          { icon: Mail, label: "Applications emailed automatically", color: "bg-purple-400/20" },
      ...
      <div className="px-6 mt-10 flex flex-col gap-3 max-w-md mx-auto w-full">
        <Link
          href="/register"
          className="block w-full text-center bg-white text-blue-800 font-bold py-4 rounded-2xl text-lg shadow-lg active:scale-95 transition-transform"
        >
